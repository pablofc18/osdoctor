...
fn sample_results() -> Vec<CheckResult> {
    ...
    vec![
        ...
        CheckResult::new("root-disk-space", "System", Ok, "Root filesystem has 403 GB free", ""),
        CheckResult::new("tmp-writable", "System", Ok, "/tmp is writable", ""),
        CheckResult::new("memory-info", "System", Ok, "Memory: 26792 MB available of 31956 MB", ""),
        CheckResult::new("failed-system-services", "Services", Ok, "No failed system services", ""),
        CheckResult::new("failed-user-services", "Services", Ok, "No failed user services", ""),
        CheckResult::new("pacman-lock", "Packages", Ok, "pacman database is unlocked", ""),
        CheckResult::new("pacman-log", "Packages", Ok, "pacman log exists", ""),
        CheckResult::new("orphan-packages", "Packages", Ok, "No orphan packages", ""),
        CheckResult::new("wayland-session", "Desktop", Ok, "Wayland session detected", ""),
        CheckResult::new("hyprland-socket", "Desktop", Ok, "Hyprland socket detected", ""),
        CheckResult::new(
            "hyprland-binds",
            "Desktop",
            Warn,
